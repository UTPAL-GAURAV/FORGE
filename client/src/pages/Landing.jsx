...
const AGENTS = [
  { name: 'Investor', role: 'Financial Attacker', emoji: '💰', color: '#e8ff47', bg: 'rgba(232,255,71,0.1)', desc: "Interrogates your valuation, runway, unit economics, and path to profitability with surgical precision.", attacks: ['CAC / LTV', 'Valuation', 'Runway math', 'Revenue model'] },
  { name: 'Competitor', role: 'Market Challenger', emoji: '⚔️', color: '#ff8c47', bg: 'rgba(255,140,71,0.1)', desc: "Challenges your moat, competitive differentiation, and why you won't be copied or crushed.", attacks: ['Defensibility', 'Moat', 'Pricing', 'Market share'] },
  { name: 'Red Team', role: 'Assumption Breaker', emoji: '🔴', color: '#ff4747', bg: 'rgba(255,71,71,0.1)', desc: 'Attacks logical gaps, contradictions, and execution risks buried in your assumptions.', attacks: ['Logic gaps', 'Contradictions', 'Execution risk', 'TAM claims'] },
  { name: 'Customer', role: 'Adoption Skeptic', emoji: '🎯', color: '#47c8ff', bg: 'rgba(71,200,255,0.1)', desc: "Questions real-world adoption, willingness to pay, and whether anyone actually needs this.", attacks: ['Willingness to pay', 'Adoption friction', 'Use case', 'Retention'] },
]
  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-actions">
          <button className="btn-primary" onClick={handleCTA}>
            {user ? '→ Go to Dashboard' : <><GoogleIcon /> Sign in with Google</>}
          </button>
      ...
      <div id="how" className="section">
        ...
        <p className="section-sub">A structured, adversarial session where four specialized agents take turns attacking your pitch. One question at a time. No open chat. No escape.</p>
        <div className="steps">
          {STEPS.map(s => (
      ...
      <div className="section">
        ...
        <p className="section-sub">Each agent has a fixed role, domain-specific attack vectors, and a persistent question queue. They never forget a loophole — even when it wasn't their turn to ask.</p>
      ...
      <div className="cta-section">
        <div className="cta-box">
          ...
          <p>The best founders don't walk into investor meetings hoping for the best. They've already survived worse.</p>
          <button className="btn-primary" onClick={handleCTA}>
            {user ? '→ Go to Dashboard' : <><GoogleIcon /> Start Your First Session</>}
          </button>
        </div>
      </div>
